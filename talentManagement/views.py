...
from talentManagement.forms import PromoteEmployeeForm, UpdatePasswordForm, ScheduleTrainingForm, \
    EmployeeOnboardingForm, SetGoalForm, GetAllEmployeeProfiles, DeleteEmployeeForm, GetEmployeeProfile
from talentManagement.models import Employee, Manager, Goal
...
def set_goals_for_employee(request):
    ...
    context = {'form': form}
    return render(request, 'setgoalform.html', context)
...
def search_employee_profiles(request):
    ...
    context = {'form': form}
    return render(request, 'search_employee_profile.html', context)
